...
@observer
export default class LuckDrawView extends React.Component<any, any> {
    state = {
        open: false,
    };
    ...
    render() {
        ...
        let initLuckUsers = [{a: "1828小牛数据353", b: 4}, {a: "1828小牛数据353", b: 4}, {
            a: "1828小牛数据353",
            b: 4
        }, {a: "1828小牛数据353", b: 4}];
            ...
            <div style={this.style.drawBox}>
                ...
                <div style={this.style.ruleBox}>
                    <div style={this.style.drawHead as any}>
                        <div style={this.style.ruleTitle}>
                            规则说明
                        </div>
